...
from mmdet3d import __version__ as mmdet3d_version, training_old_version
from mmdet3d.apis import train_model_vod
...
def main():
    ...
    # init distributed env first, since logger depends on the dist info.初始化分布式环境
    ...
    try:
        ...
        if 'load_radar_from' in cfg:
            ...
            print('cfg.load_radar_from =', cfg.get('load_radar_from', None))
        if 'load_lidar_from' in cfg:
            ...
            print('cfg.load_lidar_from =', cfg.get('load_lidar_from', None))
        ...
        print(f"[RANK {rank}] CAUGHT AN EXCEPTION:\n{error_info}")
