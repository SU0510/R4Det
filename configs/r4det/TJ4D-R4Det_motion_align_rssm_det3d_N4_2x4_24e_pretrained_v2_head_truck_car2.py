...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        anchor_class_mapping=[0, 0, 0, 1, 2, 2, 3, 3, 3],  # Pedx3, Cyc, Carx2, Truckx3
        use_iou_branch=True,
        anchor_generator=dict(
            ...
            ranges=[
                ...
                [0, -40.0, -1.363, 70.4, 40.0, -1.363],  # Car large (SUV/van)
                [0, -40.0, -1.403, 70.4, 40.0, -1.403],  # Truck short/van
                [0, -40.0, -1.403, 70.4, 40.0, -1.403],  # Truck standard
                [0, -40.0, -1.403, 70.4, 40.0, -1.403],  # Truck long/semi
            ],
            sizes=[
                ...
                [0.78, 1.77, 1.60],  # Cyc
                [1.84, 4.56, 1.70],  # Car
                [1.94, 5.07, 2.02],  # Car large (SUV/van p90)
                [2.50, 6.72, 2.36],  # Truck short/van (kmeans c0)
                [3.81, 9.96, 2.66],  # Truck standard (kmeans c1)
                [4.09, 17.88, 3.08], # Truck long/semi (kmeans c2)
            ],
            rotations=[0, 1.57],
            reshape_out=False),
