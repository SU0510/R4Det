...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        truck_refine_dims=(0, 1, 4),  # dx, dy, dl
        truck_anchor_class=5,           # Truck is the 6th anchor size (index 5)
        truck_refine_detach=True,       # detach refine input -> block gradient into shared BEV
