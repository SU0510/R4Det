...
| epoch | N=4 (hdim=128) | N=3 (hdim=64) | N=2 v3 | baseline_temporal |
|---|---:|---:|---:|---:|
| 1  |  3.07 |  2.51 |  9.33 | -- |
| 2  | 13.87 | 11.52 | 13.89 | -- |
| 3  | 16.51 | 17.33 | 15.82 | -- |
| 4  | 19.77 | 18.62 | 21.09 | -- |
| 5  | 25.52 | 25.96 | 22.97 | -- |
| 6  | 28.34 | 28.21 | 24.73 | 29.82 |
| 7  | 30.43 | 30.74 | 27.56 | 28.66 |
| 8  | 28.94 | 29.47 | 31.40 | 32.31 |
| 9  | 31.70 | 31.11 | 30.48 | 31.28 |
| 10 | 30.36 | 28.05 | 33.01 | 31.75 |
| 11 | 32.13 | 31.58 | 33.77 | 31.04 |
| 12 | 33.55 | 32.82 | 32.94 | 34.50 |
| 13 | 32.91 | 32.46 | 30.97 | 31.00 |
| 14 | 32.97 | **34.27** | 33.02 | 34.47 |
| 15 | 32.58 | 32.73 | 32.62 | 33.13 |
| 16 | 32.84 | 31.94 | 32.85 | 34.46 |
| 17 | **34.05** | 32.60 | 31.90 | -- |
| 18 | 32.07 | 33.27 | 32.93 | -- |
...
| 7 | v1 RSSM (KL broken) | 2 | 64 | 10 | 30.89 |

### 核心发现

1. N=2->3 有 +0.50 微弱但正向提升，主要来自 Truck (+3.83)
2. N=3->4 总体零收益甚至微负 (34.27->34.05)，边际帧数收益已耗尽
3. hidden_dim=128 确实能改善3D框精度 (Car strict +4.48)，但可能以recall为代价 (Car loose -2.03)
4. 所有RSSM变体都没超过简单的N=2 GRU baseline (34.50) -- 差距0.23-0.45，统计噪声级
5. Pedestrian 3D strict 对所有模型都是坏的 (0.01-0.05) -- 瓶颈在检测头不在时序融合
6. 18 epoch 对更大模型 (hdim=128) 可能不够，ep17才peak且ep18暴跌

### 待做消融

- [ ] N=3 + hidden_dim=128（config: TJ4D-R4Det_motion_align_rssm_det3d_N3_hdim128_2x4_12e.py）: 隔离hidden_dim对Car strict的贡献
- [ ] N=4 + hidden_dim=64（如果需要）: 隔离N=4对Car loose的影响
